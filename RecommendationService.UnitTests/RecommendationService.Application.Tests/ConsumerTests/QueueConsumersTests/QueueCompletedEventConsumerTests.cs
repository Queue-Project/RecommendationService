...
public class QueueCompletedEventConsumerTests
{
    private readonly Mock<ILogger<QueueCompletedEventConsumer>> _mockLogger;
    ...
    private readonly QueueCompletedEventConsumer _consumer;

    public QueueCompletedEventConsumerTests()
    {
        _mockLogger = new Mock<ILogger<QueueCompletedEventConsumer>>();
        _mockContext = new Mock<ConsumeContext<QueueEvent>>();
        _context = TestDbContextFactory.Create();
        _mockScoreService = new Mock<IRecommendationScoreService>();
        _consumer = new QueueCompletedEventConsumer(_mockLogger.Object, _context, _mockScoreService.Object);
    }
    ...
    public async Task Consume_Should_Update_Data_When_Review_Created_Event_Received()
    {
        ...
        savedEmployee!.CompletedQueues.ShouldBe(1);
