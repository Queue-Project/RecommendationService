...
public class RecommendedEmployeeResponseTests
{
    [Fact]
    public void RecommendationResponse_ShouldSerializeAndDeserializeCorrectly()
    {
        var originalRequest = new RecommendedEmployeeResponse()
        {
            EmployeeId = 1,
            ServiceId = 1,
            BranchId = 1,
        ...
        var deserializedRequest = MessagePackSerializer.Deserialize<RecommendedEmployeeResponse>(bytes);
