...
public class RecommendedServiceResponseTests
{
    [Fact]
    public void RecommendationResponse_ShouldSerializeAndDeserializeCorrectly()
    {
        var originalRequest = new RecommendedServiceResponse()
        {
            ServiceId = 1,
            BranchId = 1,
            CategoryId = 1,
        ...
        var deserializedRequest = MessagePackSerializer.Deserialize<RecommendedServiceResponse>(bytes);
